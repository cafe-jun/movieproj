...
<%-- 	<tr height="50">
	...
	<tr height="50">
		...
		<td style="border: 1px solid; border-color: rgb(223,222,214);" rowspan="2">
...
<tr>
	<td align="center" colspan="3" height="300" style="font-family: 굴림; color: rgb(102,102,102); font-size: 11pt;">사용 가능한 CJ ONE 할인쿠폰이(가) 없습니다.</td>
...
<tr align="center" style="border-bottom: 2px solid; border-top: 2px solid; border-left: 2px solid; border-right: 2px solid;" bordercolor="rgb(223,222,214)">
	...
	<td align="left"  colspan="2" style="color: rgb(102,102,102); font-size: 10pt; font-family: 굴림;">
...
<tr> 
	<td style="font-family: 굴림; background-color: rgb(242,240,229);" height="50">
		<input type="checkbox" name="pay" value="신용카드" onclick="chkBoxCheck(0); javascript:location.href='<%=cp%>/movies/phone.do';"/><b>신용카드&nbsp;&nbsp;&nbsp;&nbsp;</b>
