...
<div class="login" style="margin-left:350px; width: 1000px; height: 20px;" align="right">
		...
		&nbsp;
		<a href="<%=cp %>/movie/signUp.do" style="color: black">회원가입</a>
		&nbsp;
...
<table width="600" align="center" cellpadding="0" cellspacing="0" style="background-color: rgb(242,240,229); border: 3px solid; border-color: rgb(51,51,51);">
	...
	<tr height="50">
		...
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;예매번호EL</b></td>
	</tr>
	
	<tr height="50">
		<td align="right" width="100" style="font-size: 10pt; color: rgb(102,102,102);">결제방법</td>
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;결제방법EL</b></td>
	</tr><br/>
	
	<tr height="50">
		<td align="right" width="100" style="font-size: 10pt; color: rgb(102,102,102);">영화명</td>
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;영화명EL</b></td>
	</tr>
	
	<tr height="50">
		<td align="right" width="100" style="font-size: 10pt; color: rgb(102,102,102);">관람일시</td>
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;관람일시EL</b></td>
	</tr>
	
	<tr height="50">
		<td align="right" width="100" style="font-size: 10pt; color: rgb(102,102,102);">관람인원</td>
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;관람인원EL</b></td>
	</tr>
	
	<tr height="50">
		<td align="right" width="100" style="font-size: 10pt; color: rgb(102,102,102);">좌석</td>
		<td align="left" width="400" style="font-size: 12pt; color: rgb(51,51,51);"><b>&nbsp;&nbsp;&nbsp;&nbsp;좌석EL</b></td>
	</tr>
	...
	<tr height="70" align="right">
		...
		<td style="font-size: 12pt; color: rgb(51,51,51);"><b>금액EL&nbsp;원&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
	</tr>
...
<table width="600" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td colspan="2" align="right"><a href="<%=cp%>/movies/cgvMain.do"><img alt="" src="<%=cp%>/movie/data/ok.png"></a></td>
	</tr>
